...
@Component({
  selector: 'app-labour-attendance-entry-edit',
  templateUrl: './labour-attendance-entry-edit.component.html',
  styleUrls: ['./labour-attendance-entry-edit.component.css']
})
export class LabourAttendanceEntryEditComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<LabourAttendanceEntryEditComponent>,
    ...
    this.fields = LabourAttendanceEntryMetadata.formFields;
  ...
  fetchCategorySelectOptions(){
    const endPoint = `${LabourAttendanceEntryMetadata.dropdownEndpoints.employeeCategory}`;
  ...
  loadWorkCategory(){
    ...
    // const branchId = this.authService.loggedInUser.branchId; 
    const branchId = 0; 
    const endPoint = `${LabourAttendanceEntryMetadata.dropdownEndpoints.employeeWorkCategory}/${companyId}/${branchId}`;
  ...
  fetchAttendanceList(){
      ...
      const endPoint = `${LabourAttendanceEntryMetadata.dropdownEndpoints.employeeBasedAttendance}/${quueryData.projectId}/${quueryData.unitId}/${quueryData.blockId}/${quueryData.floorId}/${quueryData.category}`;
  ...
  get httpRequest(): Observable<AttendanceEntry> {
    if (this.isEdit) {
      return this.dataHandler.put<AttendanceEntry>(LabourAttendanceEntryMetadata.serviceEndPoint, this.payload);
    } else {
      delete this.model.Id;
      return this.dataHandler.post<AttendanceEntry>(LabourAttendanceEntryMetadata.serviceEndPoint, this.payload);
    }
  }
